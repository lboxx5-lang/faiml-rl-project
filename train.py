...
Examples:
    ...
    python3 train.py --algorithm ac --n-steps 5             --n-episodes 10000
...
def main():
    ...
    tag = f"{args.algorithm}_b{args.baseline}_n{args.n_steps}_s{args.seed}"
    ...
    print(
        ...
        f"baseline={args.baseline} | n_steps={args.n_steps} | "
